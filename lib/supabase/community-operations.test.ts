...
import { claimVolunteerRole, createSnackReminderDrafts, unclaimSnackSlot } from "./operations";
...
describe("community snack and volunteer operations", () => {
  ...
  it("enforces volunteer role caps before assigning a user", async () => {
    ...
    const result = await claimVolunteerRole({ signupId: "volunteer-1", userId: "user-parent-1" });

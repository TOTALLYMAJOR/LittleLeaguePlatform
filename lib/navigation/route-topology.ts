...
/**
 * Sidebar section names. Each name states the job the section serves, so a
 * signed-in staff user can pick a destination without reading every label.
 * Keep this list short: one section per recognizable job, not one per route.
 */
...
export const routeTopology = [
  route("/", "Home", "HM", "public", "Public", ["signed_out", "signed_in"], false, false, false, false, 1, false, {
    shellFamily: "neutral",
    primaryNavigationFamily: "active-role",
    familyMobileTab: "home"
  }),
  route("/registration", "Sign up", "SU", "public", "Public", ["signed_out", "signed_in"], true, true, true, false),
  route("/schedule", "Calendar", "CL", "public", "Public", ["signed_out", "signed_in"], true, true, true, false, 3),
  route("/sponsors", "Sponsors", "SP", "public", "Public", ["signed_out", "signed_in"], false, false, true, false),
  route("/auth", "Sign in", "AU", "support", "Public", ["signed_out"], true, true, true, false, 4),
  route("/account", "Account", "AC", "support", "Account", ["signed_in"], true, true, true, true, 5, false, {
  ...
  route("/access/status", "Access Status", "AS", "support", "Account", ["signed_out", "signed_in"], false, false, true, false, undefined, false, {
    surfaceFamily: "transition",
    shellFamily: "neutral",
    primaryNavigationFamily: "none",
    neutralTransition: true
  }),
  route("/invite/accept", "Accept Invite", "AI", "support", "Account", ["signed_out", "signed_in"], false, false, false, false, undefined, false, {
    surfaceFamily: "transition",
    shellFamily: "neutral",
    primaryNavigationFamily: "none",
    neutralTransition: true
  }),
  route("/invite/recover", "Recover Invite", "RI", "support", "Account", ["signed_in"], false, false, true, true, undefined, false, {
    familyMobileTab: "more",
    parentMoreDescription: "Get help with an invitation, access review, or account question.",
    parentMorePriority: 6
  }),
  route("/invite/expired", "Expired Invite", "EX", "support", "Account", ["signed_out", "parent", "coach", "admin"], false, false, false, false),
  route("/caregiver/accept", "Accept temporary care", "TC", "support", "Account", ["signed_out", "signed_in"], false, false, false, false),
  route("/caregiver", "Temporary caregiver", "TC", "support", "Account", ["signed_in"], false, false, false, true),
  route("/offline", "Offline", "OF", "support", "Account", ["signed_out", "parent", "coach", "admin"], false, false, false, false, undefined, false, {
    familyMobileTab: "more",
  ...
  route("/coach", "Today", "HM", "coach", "Today", ["coach"], true, true, true, true, 1),
  route("/coach/schedule", "Schedule", "SC", "coach", "Schedule", ["coach"], true, true, true, true, 2),
  ...
  route("/coach/practice-recaps", "Parent Replay", "PR", "coach", "Communication", ["coach"], true, true, true, true, 5),
  ...
  route("/coach/weather-fields", "Weather & Fields", "WF", "coach", "Schedule", ["coach"], true, true, true, true),
  route("/coach/drafts", "Drafts to Review", "DR", "coach", "Communication", ["coach"], true, true, true, true),
  compatibility("/coach/settings", "Coach Settings", "ST", "coach", "Today", "/coach", ["coach"], true),
  compatibility("/coach/rsvps", "Coach RSVPs", "CR", "coach", "Team", "/coach/attendance", ["coach"], true),
  compatibility("/coach/parent-replay", "Parent Replay", "PR", "coach", "Communication", "/coach/practice-recaps", ["coach"], true),

  route("/admin", "Overview", "OV", "admin", "Today", ["admin"], true, true, true, true, 1, true),
  route("/admin/registrations", "Registrations", "RR", "admin", "Registration & Access", ["admin"], true, true, true, true, 2, true),
  route("/admin/teams", "Teams", "TM", "admin", "Season Operations", ["admin"], true, true, true, true, 3, true),
  route("/admin/family-access", "Family Access", "FA", "admin", "Registration & Access", ["admin"], true, true, true, true, 4, true),
  route("/admin/schedule-venues", "Schedule & Venues", "SV", "admin", "Season Operations", ["admin"], true, true, true, true, 5, true),
  route("/admin/communications", "Communications", "CM", "admin", "Communication", ["admin"], true, true, true, true, undefined, true),
  compatibility("/admin/safety-weather", "Schedule & Venues", "SV", "admin", "Season Operations", "/admin/schedule-venues", ["admin"], true),
  route("/admin/media-review", "Media Review", "MR", "admin", "Trust & Safety", ["admin"], true, true, true, true, undefined, true),
  route("/admin/sponsors", "Sponsors", "SP", "admin", "League Setup", ["admin"], true, true, true, true, undefined, true),
  route("/admin/branding", "Branding", "BR", "admin", "League Setup", ["admin"], true, true, true, true, undefined, true),
  route("/admin/reports-archive", "Reports & Archive", "AR", "admin", "League Setup", ["admin"], true, true, true, true, undefined, true),
  ...
  compatibility("/admin/settings", "Settings & Providers", "OP", "admin", "League Setup", "/admin/operations", ["admin"], true),
  route("/admin/operations", "Settings & Providers", "OP", "admin", "League Setup", ["admin"], true, true, true, true, undefined, true),
  route("/admin/imports", "Imports", "IM", "admin", "Season Operations", ["admin"], true, true, true, true, undefined, true),
  route("/admin/invites", "Invites", "IN", "admin", "Registration & Access", ["admin"], true, true, true, true, undefined, true),
  route("/admin/memberships", "Memberships", "MB", "admin", "Registration & Access", ["admin"], true, true, true, true, undefined, true),
  route("/admin/health", "Health", "HL", "admin", "Today", ["admin"], true, true, true, true, undefined, true),
  compatibility("/admin/guardian-links", "Guardian Links", "GL", "admin", "Registration & Access", "/admin/family-access", ["admin"], true),
  compatibility("/admin/themes", "Themes", "TH", "admin", "League Setup", "/admin/branding", ["admin"], true),
  compatibility("/admin/security", "Security", "SE", "admin", "Trust & Safety", "/admin/security-audit", ["admin"], true),
  compatibility("/admin/archive", "Archive", "AR", "admin", "League Setup", "/admin/reports-archive", ["admin"], true),

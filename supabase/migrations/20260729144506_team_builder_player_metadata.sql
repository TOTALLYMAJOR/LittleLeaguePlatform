-- Team Builder player metadata for service-owned admin preview planning.
-- This extends the existing private team_build_plans table without adding a
-- family-readable surface or changing its service-role-only grants.

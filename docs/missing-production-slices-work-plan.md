...
- 2026-07-29: LPM-014 added the local Team Builder player metadata slice:
  ...
  - Migration `20260729144506_team_builder_player_metadata.sql` extends existing service-owned `team_build_plans` persistence with idempotent JSON metadata/constraint columns and does not introduce a new family-readable table.

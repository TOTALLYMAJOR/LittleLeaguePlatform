...
4. Dark mode: family routes light-only until a deliberate dark theme passes an authenticated all-routes proof (04 §7). No surface may ship in accidental-inversion state.

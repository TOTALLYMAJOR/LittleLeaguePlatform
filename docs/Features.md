...
- **Preview migration and focused lifecycle proof remain retained.** The no-production-data preview branch `leaguepilot-migration-gap-qa-20260726` (`gmrvnnkxksqkcxcmydhr`) is aligned through `20260726144407`; parent, coach, and anonymous RLS checks plus the provider-free transportation and caregiver lifecycle proof pass there.

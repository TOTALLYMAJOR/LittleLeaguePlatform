...
| Admin Dashboard | Phase 1 - Launch Readiness | Done | `/admin` | `components/feature-panels.test.tsx`; `npm test`; `npm run build` | Admin Home starts with league health: teams needing help, pending review queues, missing coaches/events, and family-link repairs. Message, billing, and team-builder sections stay review-only and provider-safe. |

...
| 3 | LP-007 team-builder publication | `done-local`; isolated-QA publish in order 8 | Admin-only Preview -> Edit -> Approve -> Publish persistence, stale-plan refusal, organization scope, and audit contracts pass 17 focused tests plus the admin readiness verifier. Isolated-QA browser/readback remains order 8. |

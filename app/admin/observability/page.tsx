...
export default async function AdminObservabilityPage() {
  ...
  if (!organizationId) {
    return <AdminAccessDeniedSurface message="An active organization context is required for observability." />;
  }

  const data = await listAdminObservabilityData({ organizationId });

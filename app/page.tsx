  ...
  return (
    <div className="page">
      <section className="hero">
        ...
        <h1>Private youth sports operations, with approval-first agentic workflows.</h1>
        <p className="lead">
          This root Next.js app implements the six MVP features from the tracking file with typed local data.
